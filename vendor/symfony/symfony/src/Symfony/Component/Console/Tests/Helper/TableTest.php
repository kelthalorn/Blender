...
TABLE
            ...
            'AbstractCell text with tags used for Output styling' => array(
                array('ISBN', 'Title', 'Author'),
                array(
...
TABLE
            ...
            'AbstractCell text with tags not used for Output styling' => array(
                array('ISBN', 'Title', 'Author'),
                array(
...
TABLE
            ...
            'AbstractCell with colspan' => array(
                array('ISBN', 'Title', 'Author'),
                array(
                    array('99921-58-10-7', 'Divine Comedy', 'Dante Alighieri'),
                    new TableSeparator(),
...
TABLE
            ...
            'AbstractCell with rowspan' => array(
                array('ISBN', 'Title', 'Author'),
                array(
                    array(
...
TABLE
            ...
            'AbstractCell with rowspan and colspan' => array(
                array('ISBN', 'Title', 'Author'),
                array(
                    array(
...
TABLE
            ...
            'AbstractCell with rowspan and colspan contains new line break' => array(
                array('ISBN', 'Title', 'Author'),
                array(
                    array(
...
TABLE
            ...
            'AbstractCell with rowspan and colspan without using TableSeparator' => array(
                array('ISBN', 'Title', 'Author'),
                array(
                    array(
                        new TableCell("9971\n-5-\n021\n0-0", array('rowspan' => 2, 'colspan' => 2)),
...
TABLE
            ...
            'AbstractCell with rowspan and colspan with separator inside a rowspan' => array(
                array('ISBN', 'Author'),
                array(
                    array(
