...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'btp_api_master.api_exception_subscriber' => 'getBtpApiMaster_ApiExceptionSubscriberService',
            'btp_api_master.http_request_json' => 'getBtpApiMaster_HttpRequestJsonService',
            'btp_api_master.resource_setter_subscriber' => 'getBtpApiMaster_ResourceSetterSubscriberService',
    ...
    /**
     * Gets the public 'btp_api_master.api_exception_subscriber' shared service.
     *
     * @return \BTP\ApiMasterBundle\EventListener\ApiExceptionSubscriber
     */
    protected function getBtpApiMaster_ApiExceptionSubscriberService()
    {
        return $this->services['btp_api_master.api_exception_subscriber'] = new \BTP\ApiMasterBundle\EventListener\ApiExceptionSubscriber(true, $this->get('logger'), $this->get('fos_rest.view_handler'));
    }

    /**
     * Gets the public 'btp_api_master.http_request_json' shared service.
     *
     * @return \BTP\ApiMasterBundle\Service\HttpRequest
     */
    protected function getBtpApiMaster_HttpRequestJsonService()
    {
        return $this->services['btp_api_master.http_request_json'] = new \BTP\ApiMasterBundle\Service\HttpRequest();
    }

    /**
     * Gets the public 'btp_api_master.resource_setter_subscriber' shared service.
     *
     * @return \BTP\ApiMasterBundle\EventListener\ResourceSetterSubscriber
     */
    protected function getBtpApiMaster_ResourceSetterSubscriberService()
    {
        return $this->services['btp_api_master.resource_setter_subscriber'] = new \BTP\ApiMasterBundle\EventListener\ResourceSetterSubscriber('API_APT');
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('cS9u39zHSZ', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lLX-VcWv8h', 0, '2LgWk5Biq8sQsOWhIc64+f', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('btp_api_master.api_exception_subscriber', 'BTP\\ApiMasterBundle\\EventListener\\ApiExceptionSubscriber');
    ...
    protected function getDoctrineMongodb_Odm_DefaultConfigurationService()
    {
        ...
        $a->setNamespace('sf_mongodb_default_87eca26c17043fd300a18148bdf398c984c8f309096c67cbd034f89a77182c99');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver(new \Doctrine\ODM\MongoDB\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/vendor/btp/api-master-bundle/Document'))), 'BTP\\ApiMasterBundle\\Document');
        ...
        $instance->setDocumentNamespaces(array('BTPApiMasterBundle' => 'BTP\\ApiMasterBundle\\Document'));
    ...
    {
        return $this->services['doctrine_mongodb.odm.default_connection'] = new \Doctrine\MongoDB\Connection('service_socle_front_storage_mongodb:27017', array('username' => 'socle', 'password' => 'HzvDTxc6AM4zYRMNeqpdtKZU', 'authSource' => 'socle'), $this->get('doctrine_mongodb.odm.default_configuration'), $this->get('doctrine_mongodb.odm.event_manager'), array());
    }
    ...
    protected function getDoctrineMongodb_Odm_EventManagerService()
    {
        ...
        $instance->addEventSubscriber($this->get('btp_api_master.resource_setter_subscriber'));
    ...
    protected function getFosRest_FormatNegotiatorService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/btp-api-analysis-point-type', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'json'), 'fallback_format' => 'html', 'prefer_extension' => false, 'methods' => NULL, 'attributes' => array(), 'stop' => false));
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'html', 1 => '*/*'), 'fallback_format' => 'html', 'prefer_extension' => false, 'methods' => NULL, 'attributes' => array(), 'stop' => false));
    ...
    {
        $this->services['fos_rest.view_handler'] = $instance = new \FOS\RestBundle\View\ViewHandler($this->get('router'), $this->get('fos_rest.serializer'), $this->get('templating', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('request_stack'), array('json' => false, 'rss' => false, 'html' => true), 400, 204, false, array('html' => 302), 'twig');
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'BTP\\ApiMasterBundle' => ($this->targetDirs[3].'/vendor/btp/api-master-bundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms-serializer/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Nelmio\\ApiDocBundle' => ($this->targetDirs[3].'/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/config/serializer'), 'Doctrine\\Bundle\\MongoDBBundle' => ($this->targetDirs[3].'/vendor/doctrine/mongodb-odm-bundle/Resources/config/serializer'), 'BlenderBundle' => ($this->targetDirs[3].'/src/BlenderBundle/Resources/config/serializer'), 'Nelmio\\CorsBundle' => ($this->targetDirs[3].'/vendor/nelmio/cors-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Resources/config/serializer')));
    ...
    {
        return $this->services['nelmio_cors.options_provider.config'] = new \Nelmio\CorsBundle\Options\ConfigProvider(array('^/btp-api-analysis-point-type' => array('allow_origin' => true, 'allow_headers' => true, 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE'), 'max_age' => 3600)), array('allow_origin' => array(), 'allow_credentials' => false, 'allow_headers' => array(), 'expose_headers' => array(), 'allow_methods' => array(), 'max_age' => 0, 'hosts' => array(), 'origin_regex' => false, 'forced_allow_origin_value' => NULL));
    }
    ...
    protected function getRouting_LoaderService()
    {
        ...
        $f->addLoader(new \FOS\RestBundle\Routing\Loader\RestRouteLoader($this, $b, $a, new \FOS\RestBundle\Routing\Loader\Reader\RestControllerReader(new \FOS\RestBundle\Routing\Loader\Reader\RestActionReader($c, ${($_ = isset($this->services['fos_rest.request.param_fetcher.reader']) ? $this->services['fos_rest.request.param_fetcher.reader'] : $this->getFosRest_Request_ParamFetcher_ReaderService()) && false ?: '_'}, $this->get('fos_rest.inflector'), true, array('json' => false, 'rss' => false, 'html' => true)), $c), 'json'));
        $f->addLoader(new \FOS\RestBundle\Routing\Loader\RestYamlCollectionLoader($b, $e, true, array('json' => false, 'rss' => false, 'html' => true), 'json'));
        $f->addLoader(new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader($b, $e, true, array('json' => false, 'rss' => false, 'html' => true), 'json'));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UpgIXdssoJ', 0, '2LgWk5Biq8sQsOWhIc64+f', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a0edd15a5e235.83392786')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'BTPApiMasterBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/btp/api-master-bundle'),
                    'namespace' => 'BTP\\ApiMasterBundle',
                ),
                'FOSRestBundle' => array(
                    'parent' => NULL,
                ...
                'JMSSerializerBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/jms-serializer/serializer-bundle/JMS/SerializerBundle'),
                ...
                'BlenderBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/BlenderBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => 'service_socle_front_storage_mongodb',
            'database_port' => 27017,
            'database_name' => 'socle',
            'database_user' => 'socle',
            'database_password' => 'HzvDTxc6AM4zYRMNeqpdtKZU',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'api_url' => 'btp-api-analysis-point-type',
            'resource_urn_prefix' => 'API_APT',
            'locale' => 'en',
            ...
            'nelmio_cors.map' => array(
                '^/btp-api-analysis-point-type' => array(
                    'allow_origin' => true,
                    'allow_headers' => true,
                    'allow_methods' => array(
                        0 => 'POST',
